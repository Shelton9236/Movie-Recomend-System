...
import com.example.demo.recommend.predictor.NeibeiHoodPridictor;
import com.example.demo.recommend.predictor.Predictor;
import com.example.demo.recommend.respository.*;
import com.example.demo.recommend.similarityCalutor.SimilarityCalculator;
import com.example.demo.recommend.similarityCalutor.itemSimilarityCalutor.CosinItemSimilarityCalutor;
...
//        return  String.format("花费(%d时%d分%d秒)",hour,minute,internal);
    ...
    public static  void  test6(){
        ...
        Set<Similarity> similaritySet=similarityCalculator.calutorsSimilarity();
